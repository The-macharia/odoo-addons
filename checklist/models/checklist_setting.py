...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        config_param_obj("checklist.entry_document_ids", self.entry_document_ids.ids)
        config_param_obj("checklist.exit_document_ids", self.exit_document_ids.ids)
        config_param_obj("checklist.product_ids", self.product_ids.ids)
        config_param_obj("checklist.notice_period", self.notice_period)
        return res
