...
class AccountLoanBankCheque(models.Model):
    ...
    voucher_id =  fields.Many2one('sale.coupon', 'Voucher',readonly=True)
...
#             inv_id2 = self.env['sale.coupon.line'].create({
# #                 'partner_id':loan.partner_id.id,
#                 'name': loan.name,
...
#             })
#                     
#             inv_id1 = self.env['sale.coupon.line'].create({
# #                 'partner_id':loan.partner_id.id,
#                 'name': loan.name,
...
#             inv_id = inv_obj.create(inv)
#             
#             self.env['sale.coupon.line'].create({
# #                 'partner_id':loan.partner_id.id,
#                 'name': loan.name,
#                 'price_unit':loan.loan,
#                 'account_id':cus_acc,
